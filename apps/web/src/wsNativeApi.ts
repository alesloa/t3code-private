...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    git: {
      ...
      stashApply: (input) => transport.request(WS_METHODS.gitStashApply, input),
      stashPop: (input) => transport.request(WS_METHODS.gitStashPop, input),
      stashDrop: (input) => transport.request(WS_METHODS.gitStashDrop, input),
      stashShow: (input) => transport.request(WS_METHODS.gitStashShow, input),
      ...
      fileDiff: (input) => transport.request(WS_METHODS.gitFileDiff, input),
